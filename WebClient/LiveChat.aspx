<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiveChat.aspx.cs" Inherits="WebClient.LiveChart" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function connectSocketServer() {
            ...
            ws = new window[support]('ws://'+host+':<%= WebSocketPort %>/sample');
            ...
            var wss = new window[support]('wss://' + host + ':<%= SecureWebSocketPort %>/sample');
